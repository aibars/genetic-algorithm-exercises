/*
Resolver el siguiente problema: A veces planteamos el problema en peso en lugar
de volumen. Dados 3 elementos, cuyos pesos son: 1800 grs., 600 grs. Y 1200 grs.
y cuyos valores son: $72, $36 y $60 respectivamente, y dado que la mochila puede
soportar hasta 3000 grs. se pide: A) Hallar una solución utilizando un algoritmo
goloso. B) Analizar dicha solución respecto a su grado de optimización y
elaborar las conclusiones que considere adecuadas.
*/
